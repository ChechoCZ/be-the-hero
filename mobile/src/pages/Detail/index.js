...
export default function Detail() {
  ...
  const message = `Hi ${incident.name}, I'm getting in touch 'cause I'd like to talk about "${incident.title}" with cost: ${Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(incident.value)}`;
  ...
  return (
    <View styles={ styles.container } >
      ...
      <View style={ styles.incident } >
        ...
        <Text style={ styles.incidentProperty }>{ incident.name } from { incident.city } / { incident.uf }</Text>
